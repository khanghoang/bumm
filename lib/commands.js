...
var writeViewTemplate = function(templateName) {
    ...
    var targetPath = path.join("app", "views", this.model.path, path.basename(template).replace('.ejs', ''));
...
var commands = {
    ...
    view : function(options) {
        ...
        console.log('Views created in directory ' + path.join('app', 'views', options.model.path));
    },
    ...
    model : function(options) {
        ...
        var target = path.join('app', 'models', options.model.path + '.js');
    ...
    route : function(options) {
        ...
        var target = path.join('app', 'routes', 'routes', options.model.path + '.js');
